    ...
    <div class="vx-row">
      <div class="vx-col w-full">
        <div class="flex items-start flex-col sm:flex-row">
          <img src="@/assets/images/portrait/small/avatar-s-1.jpg" class="mr-8 rounded h-24 w-24" />
          <!-- <vs-avatar :src="`@/assets/images/portrait/small/avatar-s-1.jpg`" size="80px" class="mr-4" /> -->
          <div>
    ...
    <div class="vx-row">
      ...
      <div class="vx-col md:w-1/2 w-full">
        ...
        <div class="mt-4">
          ...
          <v-select v-model="selectedRole" :clearable="false" :options="roleOptions" v-validate="'required'" name="role" :dir="$vs.rtl ? 'rtl' : 'ltr'" />
...
export default {
  ...
  methods: {
    ...
    getData(){
      ...
      this.data_not_found = ! Object.keys(this.role_data).length
    ...
    prepareRoleOptions(){
      this.roleOptions = this.roles.map(v => { return {label:v.name,value:v.id}})
      this.selectedRole =  {
        label : this.data.role_name ,
